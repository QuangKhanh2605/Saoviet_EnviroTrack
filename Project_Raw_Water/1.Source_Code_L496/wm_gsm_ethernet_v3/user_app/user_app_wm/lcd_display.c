...
//    {   __SC1_SALINITY,     "Do man: ",         NULL,   _DTYPE_I16,      0xFE,   "  %",     5,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_TEMP,         "Temp  : ",         NULL,   _DTYPE_I16,      0xFE,   "  ‰C",    5,  0,  0x00,    _LCD_SCREEN_CM44    },
...
//    {   __SET_CALIB_SS_EC,  "3.EC",             NULL,   _DTYPE_STRING,   0,     NULL,       5,  14, 0x00,    _LCD_SCR_SET_CALIB},
    {   __SET_CALIB_SS_TUR, "2.Turbidity",      NULL,   _DTYPE_STRING,   0,     NULL,       4,  14, 0x00,    _LCD_SCR_SET_CALIB},
    {   __SET_CALIB_VALUE,  "3.Value",          NULL,   _DTYPE_STRING,   0,     NULL,       5,  14, 0x00,    _LCD_SCR_SET_CALIB},
