...
void Handle_Data_Trans_SS_Turbidity(sData *sFrame, uint8_t KindTrans)
{
    switch(KindTrans)
    {
        ...
        case _RS485_SS_TUR_CALIB_READ_MEASURE_AD:
            ModRTU_Master_Read_Frame(sFrame, ID_DEFAULT_SS_TURBIDITY, 0x03, 0x0013, 0x02);
            break; 
            
        case _RS485_SS_TUR_CALIB_READ_POINT_CALIB:
            ModRTU_Master_Read_Frame(sFrame, ID_DEFAULT_SS_TURBIDITY, 0x03, 0x0024, 0x08);
            break; 
            
        case _RS485_SS_TUR_CALIB_1ST_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURBIDITY, 0x10, 0x0024, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_1ST_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURBIDITY, 0x10, 0x0026, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_2ND_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURBIDITY, 0x10, 0x0028, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_2ND_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURBIDITY, 0x10, 0x002A, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
...
void Handle_Data_Recv_SS_Turbidity(sData sDataRS485, uint8_t KindRecv)
{
    ...
    switch(KindRecv)
    {
        ...
        case _RS485_SS_TUR_CALIB_READ_POINT_CALIB:
          ...
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turbidity.sFirst_Calibration.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sFirst_Calibration.Scale);  
          
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turbidity.First_AD_u32 =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, 0x00);  
          ...
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turbidity.Second_AD_u32 =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, 0x00);  
          break;
...
void Handle_Data_Measure(uint8_t KindRecv)
{
    switch(KindRecv)
    {
        case _RS485_SS_PH_OPERA:
            ...
            sDataSensorMeasure.sTemperature = sSensor_pH.sTemperature_Value;
...
void        Init_Parameter_Sensor(void)
{
    ...
    sSensor_Turbidity.sFirst_Calibration.Scale  = 0xFF;
    sSensor_Turbidity.sSecond_Calibration.Scale = 0xFF;
