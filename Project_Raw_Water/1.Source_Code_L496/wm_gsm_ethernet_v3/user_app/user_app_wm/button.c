...
//                                       NULL, 0xF1);
                ...
                case __SET_CALIB_VALUE:
                    ...
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_VALUE, 0,
                                       __SET_VALUE_PH_WATER, __SET_VALUE_NTU, __SET_VALUE_PH_WATER,
                                       NULL, 0x00);
                    break;
            }
            break;
                ...
                case __SET_TUR_AD_P1:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        ...
                        case 1:
                            ...
                            Old_Value_f = Handle_int32_To_Float_Scale(sButton.Old_value, 0x00);
                            RS485_LogData_Calib(_RS485_SS_TUR_CALIB_1ST_AD, &Old_Value_f, sizeof(uint32_t));
                            break;
                ...
                case __SET_TUR_AD_P2:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        ...
                        case 1:
                            ...
                            Old_Value_f = Handle_int32_To_Float_Scale(sButton.Old_value, 0x00);
                            RS485_LogData_Calib(_RS485_SS_TUR_CALIB_2ND_AD, &Old_Value_f, sizeof(uint32_t));
                            break;
